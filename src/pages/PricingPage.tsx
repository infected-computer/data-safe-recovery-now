...
const pricingPlans = [
  ...
  },
  {
    name: "שחזור סטנדרטי",
    price: "₪350-₪600",
    description: "שחזור קבצים ונתונים במצבים סטנדרטיים",
    features: [
      "כולל את כל שירותי האבחון",
      "שחזור עד 100GB נתונים",
      "קבצים שנמחקו או אבדו",
      "תיקון פרטיציות פגומות",
  ...
  },
  {
    name: "שחזור מורכב",
    price: "₪700-₪1,200",
    description: "למקרים מורכבים הדורשים טיפול מיוחד",
    features: [
      "כל השירותים הכלולים בחבילה הסטנדרטית",
      "שחזור עד 500GB נתונים",
      "כוננים עם נזק פיזי",
      "מערכות RAID מורכבות",
      "קבצים בפורמטים מתקדמים",
  ...
  {
    name: "פתרונות ארגוניים",
    price: "הצעת מחיר מותאמת",
    description: "שירותי שחזור מקצועיים לעסקים וארגונים",
    features: [
      "כל השירותים המתקדמים ברמה הגבוהה ביותר",
      "ללא הגבלות נפח",
      "סרברים ומערכות ארגוניות",
      "זמינות 24/7 לתמיכה",
      "הסכמי רמת שירות (SLA)",
      "ייעוץ למניעת אובדן נתונים עתידי",
      "הדרכת צוותים טכניים"
    ],
    popular: false,
