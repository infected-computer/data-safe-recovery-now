...
const values = [
  {
    ...
    description: "עובדים בשקיפות מלאה ונותנים לכם לראות את התהליך בזמן אמת"
  },
  {
    icon: Award,
    title: "מקצועיות ללא פשרות",
    description: "משתמשים בכלים המתקדמים ביותר ובשיטות העבודה המוכחות"
  },
  {
    icon: Users,
    title: "שירות אישי",
  ...
  },
  {
    icon: CheckCircle,
    title: "ללא סיכון",
    description: "בדיקה חינמית וללא התחייבות - משלמים רק לאחר תוצאות"
  }
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 font-hebrew text-muted-foreground">
              <p>
                התחלתי את הדרך בתחום שחזור הנתונים מתוך אהבה אמיתית לטכנולוגיה 
                ורצון לעזור לאנשים במצבים קשים. ראיתי איך אובדן נתונים יכול להרוס 
                עסקים ולגרום לכאב אישי עמוק.
              </p>
              <p>
                במהלך השנים פיתחתי מתודולוגיה מיוחדת לעבודה מרחוק שמאפשרת 
                ללקוחות לקבל שירות מקצועי ללא צורך לצאת מהבית. זה חוסך זמן, 
                כסף ומתח למשפחות ולעסקים.
              </p>
              <p>
                היום אני גאה להיות חלק מהצלחות רבות - החזרת תמונות משפחתיות 
