      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="prose prose-lg max-w-none font-hebrew text-right space-y-8">
          ...
          <section>
            ...
            <p className="mb-4">
              אנחנו אוספים מידע במטרה לספק לכם שירות מקצועי ואמין:
            </p>
            <ul className="list-disc pr-6 space-y-2">
              <li>פרטי קשר בסיסיים (שם, טלפון, אימייל)</li>
              <li>תיאור הבעיה הטכנית</li>
              <li>מידע טכני על המחשב והמערכת</li>
              <li>רשימת קבצים שנמצאו לשחזור (רק שמות, לא תוכן)</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pr-6 space-y-2">
              ...
              <li>אין שיתוף מידע עם פלטפורמות חיצoniות</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-card p-4 rounded-lg border">
                ...
                <p className="text-sm">נמחקים מיד לאחר מסירה ללקוח</p>
              </div>
            </div>
          </section>
